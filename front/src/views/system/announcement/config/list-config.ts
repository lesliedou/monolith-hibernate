...
const searchForm = (): any[] => [
  ...
  },
  {
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['PriorityLevel'], style: 'width: 100%' },
  },
  {
    title: '消息类型',
    field: 'category',
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['AnnoCategory'], style: 'width: 100%' },
  },
  {
    title: '通告对象类型',
    field: 'receiverType',
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['ReceiverType'], style: 'width: 100%' },
  },
  {
    title: '发布状态',
    field: 'sendStatus',
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['AnnoSendStatus'], style: 'width: 100%' },
  },
  {
    title: '发布时间',
    field: 'sendTime',
  ...
  },
  {
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['AnnoBusinessType'], style: 'width: 100%' },
  },
  {
    title: '业务id',
    field: 'businessId',
  ...
  },
  {
    ...
    operator: '',
    type: 'Enum',
    componentProps: { options: allEnumsDict['AnnoOpenType'], style: 'width: 100%' },
  },
  {
    title: '组件/路由 地址',
    field: 'openPage',
