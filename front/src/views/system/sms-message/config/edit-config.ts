...
const fields = (): FormSchema[] => [
  ...
  },
  {
    ...
    field: 'sendType',
    component: 'Select',
    componentProps: { placeholder: '请选择发送方式', options: allEnumsDict.MessageSendType, style: 'width: 100%' },
    rules: [],
  },
  {
    label: '接收人',
  ...
  },
  {
    ...
    field: 'sendStatus',
    component: 'Select',
    componentProps: { placeholder: '请选择推送状态', options: allEnumsDict.SendStatus, style: 'width: 100%' },
    rules: [],
  },
  {
    label: '发送次数 超过5次不再发送',
