            ...
            <div class="aui-formBox">
              <div class="aui-formWell">
                  ...
                  <a-form ref="loginRef" :model="formData" v-if="activeIndex === 'accountLogin'" @keyup.enter.native="loginHandleClick">
                    <div class="aui-account">
                      <div class="aui-inputClear">
                        ...
                        <a-form-item>
                          <a-input class="fix-auto-fill" placeholder="账号" v-model:value="formData.username" />
                        </a-form-item>
                      </div>
                      <div class="aui-inputClear">
                        <i class="icon icon-password"></i>
                        <a-form-item>
                          <a-input class="fix-auto-fill" type="password" placeholder="密码" v-model:value="formData.password" />
                        </a-form-item>
                      </div>
                      <div class="aui-inputClear">
                        <i class="icon icon-code"></i>
                        <a-form-item>
                          <a-input class="fix-auto-fill" type="text" placeholder="验证码" v-model:value="formData.inputCode" />
                        </a-form-item>
                        <div class="aui-code">
                      ...
                      <div class="aui-flex">
                        ...
                        <div class="aui-forget">
                          <a @click="forgetHandelClick">忘记密码?</a>
                        </div>
                      </div>
                    </div>
                  </a-form>
                  <a-form v-else ref="phoneFormRef" :model="phoneFormData" @keyup.enter.native="loginHandleClick">
                    <div class="aui-account phone">
                      <div class="aui-inputClear phoneClear">
                        <a-input class="fix-auto-fill" placeholder="手机号码" v-model:value="phoneFormData.mobile" />
                      </div>
                      <div class="aui-inputClear">
                        <a-input class="fix-auto-fill" :maxlength="6" placeholder="短信验证码" v-model:value="phoneFormData.smscode" />
                        <div v-if="showInterval" class="aui-code" @click="getLoginCode">
                          <a>获取验证码</a>
                        </div>
                        <div v-else class="aui-code">
                          <span class="aui-get-code code-shape">{{ `${unref(timeRuning)}秒后重新获取` }}</span>
                        </div>
                      </div>
                    </div>
                  </a-form>
                ...
                <div class="aui-formButton">
                  ...
                  <div class="aui-flex">
                    <a class="aui-linek-code aui-flex-box" @click="codeHandleClick">二维码登录</a>
                  </div>
                  <div class="aui-flex">
                    <a class="aui-linek-code aui-flex-box" @click="registerHandleClick">注册</a>
                  </div>
                </div>
              </div>
...
async function accountLogin() {
  ...
  try {
    ...
    notification.error({
      message: '错误提示',
      description: error.message || 'Translation missing for sys.login.networkExceptionMsg',
      duration: 3,
    });
...
async function phoneLogin() {
  ...
  try {
    ...
    notification.error({
      message: 'Translation missing for sys.login.networkExceptionMsg',
      description: error.message || 'Translation missing for sys.login.networkExceptionMsg',
      duration: 3,
    });
  } finally {
