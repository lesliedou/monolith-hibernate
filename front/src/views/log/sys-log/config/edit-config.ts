...
const fields = (): FormSchema[] => [
  ...
  },
  {
    ...
    field: 'logType',
    component: 'Select',
    componentProps: { placeholder: '请选择日志类型', options: allEnumsDict.LogType, style: 'width: 100%' },
    rules: [],
  },
  {
    label: '日志内容',
  ...
  },
  {
    ...
    field: 'operateType',
    component: 'Select',
    componentProps: { placeholder: '请选择操作类型', options: allEnumsDict.OperateType, style: 'width: 100%' },
    rules: [],
  },
  {
    label: '操作用户账号',
