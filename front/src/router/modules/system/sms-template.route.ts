  ...
  children: [
    {
      ...
      component: () => import('@/views/system/sms-template/sms-template-list.vue'),
      meta: { title: '消息模板列表' },
    },
    {
      path: 'new',
      name: 'systemSmsTemplateNew',
      component: () => import('@/views/system/sms-template/sms-template-edit.vue'),
      meta: { title: '新建消息模板' },
    },
    {
      path: ':entityId/edit',
    ...
    },
    {
      ...
      component: () => import('@/views/system/sms-template/sms-template-detail.vue'),
