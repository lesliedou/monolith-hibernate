<template>
  <div :class="prefixCls">
    <Badge :count="count" :overflowCount="9" :offset="[-4, 10]" dot :numberStyle="numberStyle" @click="clickBadge">
      <BellOutlined />
    </Badge>
...
<script lang="ts">
import { computed, defineComponent, ref, reactive, onMounted, getCurrentInstance, onUnmounted } from 'vue';
