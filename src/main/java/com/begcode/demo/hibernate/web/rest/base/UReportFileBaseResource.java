...
import com.begcode.demo.hibernate.service.UReportFileQueryService;
import com.begcode.demo.hibernate.service.UReportFileService;
 ...
 * 管理实体{@link com.begcode.demo.hibernate.domain.UReportFile}的REST Controller。
 */
public class UReportFileBaseResource {
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<UReportFileDTO> data = uReportFileService.findAll(Pageable.unpaged()).getContent();
