...
import com.begcode.demo.hibernate.service.MailService;
...
import com.begcode.demo.hibernate.web.rest.errors.EmailAlreadyUsedException;
import com.begcode.demo.hibernate.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.begcode.demo.hibernate.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResource {
    ...
    public ResponseEntity<PageRecord<AdminUserDTO>> getAllUsers(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
        ...
        result.records(page.getContent()).size(page.getSize()).total(page.getTotalElements()).page(page.getNumber());
