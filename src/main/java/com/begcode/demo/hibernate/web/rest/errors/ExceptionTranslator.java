...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.begcode.demo.hibernate.service.EmailAlreadyUsedException ||
            ex instanceof com.begcode.demo.hibernate.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.begcode.demo.hibernate.service.InvalidPasswordException
