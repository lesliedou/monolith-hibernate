...
import com.begcode.demo.hibernate.service.BusinessTypeQueryService;
import com.begcode.demo.hibernate.service.BusinessTypeService;
 ...
 * 管理实体{@link com.begcode.demo.hibernate.domain.BusinessType}的REST Controller。
 */
public class BusinessTypeBaseResource {
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<BusinessTypeDTO> data = businessTypeService.findAll(Pageable.unpaged()).getContent();
