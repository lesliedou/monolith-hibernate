...
public class ApiPermissionBaseResource {
    ...
    public ResponseEntity<ApiPermissionDTO> updateApiPermission(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, apiPermissionDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<ApiPermissionDTO> partialUpdateApiPermission(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, apiPermissionDTO.getId().toString())
        );
    }
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<ApiPermissionDTO> data = apiPermissionService.findAll(Pageable.unpaged()).getContent();
    ...
    public ResponseEntity<PageRecord<ApiPermissionDTO>> getAllApiPermissionsofTree(ApiPermissionCriteria criteria, Pageable pageable) {
        ...
        Page<ApiPermissionDTO> page = apiPermissionQueryService.findAllTop(criteria, pageable);
        PageRecord<ApiPermissionDTO> result = new PageRecord<>();
