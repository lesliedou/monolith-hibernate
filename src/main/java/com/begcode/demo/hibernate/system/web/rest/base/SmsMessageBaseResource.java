...
public class SmsMessageBaseResource {
    ...
    public ResponseEntity<PageRecord<SmsMessageDTO>> getAllSmsMessages(
        ...
        Page<SmsMessageDTO> page;
        page = smsMessageQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<SmsMessageDTO> data = smsMessageService.findAll(Pageable.unpaged()).getContent();
