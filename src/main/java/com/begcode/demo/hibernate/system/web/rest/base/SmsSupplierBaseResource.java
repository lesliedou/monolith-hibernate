...
public class SmsSupplierBaseResource {
    ...
    public ResponseEntity<SmsSupplierDTO> updateSmsSupplier(
        ...
        if (!smsSupplierRepository.existsById(id)) {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, smsSupplierDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<SmsSupplierDTO> partialUpdateSmsSupplier(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, smsSupplierDTO.getId().toString())
        );
    }
    ...
    public ResponseEntity<PageRecord<SmsSupplierDTO>> getAllSmsSuppliers(
        ...
        Page<SmsSupplierDTO> page;
        page = smsSupplierQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<SmsSupplierDTO> data = smsSupplierService.findAll(Pageable.unpaged()).getContent();
