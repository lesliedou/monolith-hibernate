...
import com.begcode.demo.hibernate.system.service.SmsTemplateQueryService;
import com.begcode.demo.hibernate.system.service.SmsTemplateService;
 ...
 * 管理实体{@link com.begcode.demo.hibernate.system.domain.SmsTemplate}的REST Controller。
 */
public class SmsTemplateBaseResource {
    ...
    public ResponseEntity<PageRecord<SmsTemplateDTO>> getAllSmsTemplates(
        ...
        Page<SmsTemplateDTO> page;
        page = smsTemplateQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<SmsTemplateDTO> data = smsTemplateService.findAll(Pageable.unpaged()).getContent();
