 ...
 * 管理实体{@link com.begcode.demo.hibernate.system.domain.AnnouncementRecord}的REST Controller。
 */
public class AnnouncementRecordBaseResource {
    ...
    public ResponseEntity<AnnouncementRecordDTO> updateAnnouncementRecord(
        ...
        if (!announcementRecordRepository.existsById(id)) {
    ...
    public ResponseEntity<PageRecord<AnnouncementRecordDTO>> getAllAnnouncementRecords(
        ...
        Page<AnnouncementRecordDTO> page;
        page = announcementRecordQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<AnnouncementRecordDTO> data = announcementRecordService.findAll(Pageable.unpaged()).getContent();
