...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.settings.domain.Dictionary} entity. This class is used
 * in {@link com.begcode.demo.hibernate.settings.web.rest.DictionaryResource} to receive all the possible filtering options from
