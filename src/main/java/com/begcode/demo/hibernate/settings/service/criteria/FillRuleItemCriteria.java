...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.settings.domain.FillRuleItem} entity. This class is used
 * in {@link com.begcode.demo.hibernate.settings.web.rest.FillRuleItemResource} to receive all the possible filtering options from
