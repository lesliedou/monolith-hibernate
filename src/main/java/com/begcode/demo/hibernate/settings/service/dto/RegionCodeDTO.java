 ...
 * {@link com.begcode.demo.hibernate.settings.domain.RegionCode}的DTO。
 */
...
public class RegionCodeDTO implements Serializable {
    ...
    private Set<RegionCodeDTO> children = new LinkedHashSet<>();
    ...
    public RegionCodeDTO children(Set<RegionCodeDTO> children) {
