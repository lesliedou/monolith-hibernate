...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.settings.domain.RegionCode} entity. This class is used
 * in {@link com.begcode.demo.hibernate.settings.web.rest.RegionCodeResource} to receive all the possible filtering options from
