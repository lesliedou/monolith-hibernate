...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.settings.domain.SysFillRule} entity. This class is used
 * in {@link com.begcode.demo.hibernate.settings.web.rest.SysFillRuleResource} to receive all the possible filtering options from
