...
public class SiteConfigBaseResource {
    ...
    public ResponseEntity<PageRecord<SiteConfigDTO>> getAllSiteConfigs(
        ...
        Page<SiteConfigDTO> page;
        page = siteConfigQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<SiteConfigDTO> data = siteConfigService.findAll(Pageable.unpaged()).getContent();
