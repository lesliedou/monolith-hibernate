...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.settings.domain.SiteConfig} entity. This class is used
 * in {@link com.begcode.demo.hibernate.settings.web.rest.SiteConfigResource} to receive all the possible filtering options from
