...
import com.begcode.demo.hibernate.settings.service.SysFillRuleQueryService;
import com.begcode.demo.hibernate.settings.service.SysFillRuleService;
 ...
 * 管理实体{@link com.begcode.demo.hibernate.settings.domain.SysFillRule}的REST Controller。
 */
public class SysFillRuleBaseResource {
    ...
    public ResponseEntity<SysFillRuleDTO> updateSysFillRule(
        ...
        if (!sysFillRuleRepository.existsById(id)) {
    ...
    public ResponseEntity<PageRecord<SysFillRuleDTO>> getAllSysFillRules(
        ...
        Page<SysFillRuleDTO> page;
        page = sysFillRuleQueryService.findByCriteria(criteria, pageable);
    ...
    public void exportToExcel(HttpServletResponse response) {
        List<SysFillRuleDTO> data = sysFillRuleService.findAll(Pageable.unpaged()).getContent();
