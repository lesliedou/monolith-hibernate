 ...
 * {@link com.begcode.demo.hibernate.settings.domain.SiteConfig}的DTO。
 */
...
public class SiteConfigDTO extends AbstractAuditingEntity<Long, SiteConfigDTO> {
    ...
    private Set<CommonFieldDataDTO> items = new LinkedHashSet<>();
    ...
    public SiteConfigDTO items(Set<CommonFieldDataDTO> items) {
        this.items = items;
        return this;
    }
