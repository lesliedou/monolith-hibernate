 ...
 * {@link com.begcode.demo.hibernate.domain.ApiPermission}的DTO。
 */
...
public class ApiPermissionDTO implements Serializable {
    ...
    private Set<ApiPermissionDTO> children = new LinkedHashSet<>();
    ...
    public ApiPermissionDTO children(Set<ApiPermissionDTO> children) {
