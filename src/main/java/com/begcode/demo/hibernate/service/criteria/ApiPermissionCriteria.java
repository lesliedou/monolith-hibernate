...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.domain.ApiPermission} entity. This class is used
 * in {@link com.begcode.demo.hibernate.web.rest.ApiPermissionResource} to receive all the possible filtering options from
