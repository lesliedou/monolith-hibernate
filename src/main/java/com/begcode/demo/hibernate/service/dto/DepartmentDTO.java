 ...
 * {@link com.begcode.demo.hibernate.domain.Department}的DTO。
 */
...
public class DepartmentDTO implements Serializable {
    ...
    private Set<DepartmentDTO> children = new LinkedHashSet<>();
    ...
    public DepartmentDTO children(Set<DepartmentDTO> children) {
        this.children = children;
        return this;
    }

    public DepartmentDTO authorities(Set<AuthorityDTO> authorities) {
