 ...
 * {@link com.begcode.demo.hibernate.domain.ViewPermission}的DTO。
 */
...
public class ViewPermissionDTO implements Serializable {
    ...
    private Set<ViewPermissionDTO> children = new LinkedHashSet<>();
    ...
    public ViewPermissionDTO children(Set<ViewPermissionDTO> children) {
