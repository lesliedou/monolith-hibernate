 ...
 * {@link com.begcode.demo.hibernate.domain.ResourceCategory}的DTO。
 */
...
public class ResourceCategoryDTO implements Serializable {
    ...
    private Set<ResourceCategoryDTO> children = new LinkedHashSet<>();
    ...
    public ResourceCategoryDTO children(Set<ResourceCategoryDTO> children) {
