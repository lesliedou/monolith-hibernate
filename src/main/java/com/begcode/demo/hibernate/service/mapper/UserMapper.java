...
public interface UserMapper extends EntityMapper<UserDTO, User> {
    ...
    @Mapping(source = "authorities", target = "authorities", qualifiedByName = "nameSet")
    ...
    @Mapping(target = "name", source = "name")
    @Mapping(target = "code", source = "code")
    default Set<AuthorityDTO> toDtoNameList(Set<Authority> authorities) {
        if (authorities == null) {
            return Collections.emptySet();
        }
        Set<AuthorityDTO> authorityList = new LinkedHashSet<>();
