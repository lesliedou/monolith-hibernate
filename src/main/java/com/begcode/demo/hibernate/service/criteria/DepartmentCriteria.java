...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.domain.Department} entity. This class is used
 * in {@link com.begcode.demo.hibernate.web.rest.DepartmentResource} to receive all the possible filtering options from
