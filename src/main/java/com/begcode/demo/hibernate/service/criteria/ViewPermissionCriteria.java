...
/**
 * Criteria class for the {@link com.begcode.demo.hibernate.domain.ViewPermission} entity. This class is used
 * in {@link com.begcode.demo.hibernate.web.rest.ViewPermissionResource} to receive all the possible filtering options from
