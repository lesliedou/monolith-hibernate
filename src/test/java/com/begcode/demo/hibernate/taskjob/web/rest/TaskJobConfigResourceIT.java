package com.begcode.demo.hibernate.taskjob.web.rest;
...
public class TaskJobConfigResourceIT {
     ...
     */
    public static TaskJobConfig createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static TaskJobConfig createUpdatedEntity(EntityManager em) {
        TaskJobConfig taskJobConfig = new TaskJobConfig()
            .name(UPDATED_NAME)
    ...
    void getAllTaskJobConfigs() throws Exception {
        ...
        taskJobConfigRepository.saveAndFlush(taskJobConfig);
    ...
    void putExistingTaskJobConfig() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedTaskJobConfig are not directly saved in db
        em.detach(updatedTaskJobConfig);
