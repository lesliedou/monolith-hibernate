...
public class SmsMessageResourceIT {
     ...
     */
    public static SmsMessage createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static SmsMessage createUpdatedEntity(EntityManager em) {
        SmsMessage smsMessage = new SmsMessage()
            .title(UPDATED_TITLE)
