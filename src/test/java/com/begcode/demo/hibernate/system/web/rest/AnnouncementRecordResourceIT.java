...
public class AnnouncementRecordResourceIT {
     ...
     */
    public static AnnouncementRecord createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static AnnouncementRecord createUpdatedEntity(EntityManager em) {
        AnnouncementRecord announcementRecord = new AnnouncementRecord()
    ...
    public void initTest() {
        announcementRecord = createEntity(em);
    }
    ...
    void getAllAnnouncementRecords() throws Exception {
        ...
        announcementRecordRepository.saveAndFlush(announcementRecord);
    ...
    void putExistingAnnouncementRecord() throws Exception {
        ...
        em.detach(updatedAnnouncementRecord);
