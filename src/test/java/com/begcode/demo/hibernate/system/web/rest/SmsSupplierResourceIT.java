...
public class SmsSupplierResourceIT {
     ...
     */
    public static SmsSupplier createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static SmsSupplier createUpdatedEntity(EntityManager em) {
        SmsSupplier smsSupplier = new SmsSupplier()
    ...
    void getAllSmsSuppliers() throws Exception {
        ...
        smsSupplierRepository.saveAndFlush(smsSupplier);
    ...
    void putExistingSmsSupplier() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedSmsSupplier are not directly saved in db
        em.detach(updatedSmsSupplier);
        updatedSmsSupplier
            .provider(UPDATED_PROVIDER)
            .configData(UPDATED_CONFIG_DATA)
            .signName(UPDATED_SIGN_NAME)
    ...
    void partialUpdateSmsSupplierWithPatch() throws Exception {
        ...
        partialUpdatedSmsSupplier.provider(UPDATED_PROVIDER).enabled(UPDATED_ENABLED);
