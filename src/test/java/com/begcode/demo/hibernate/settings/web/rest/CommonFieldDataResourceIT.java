...
public class CommonFieldDataResourceIT {
     ...
     */
    public static CommonFieldData createEntity(EntityManager em) {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CommonFieldData createUpdatedEntity(EntityManager em) {
        CommonFieldData commonFieldData = new CommonFieldData()
            .name(UPDATED_NAME)
            .value(UPDATED_VALUE)
            .label(UPDATED_LABEL)
    ...
    public void initTest() {
        commonFieldData = createEntity(em);
    }
    ...
    void getAllCommonFieldData() throws Exception {
        ...
        commonFieldDataRepository.saveAndFlush(commonFieldData);
    ...
    void putExistingCommonFieldData() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedCommonFieldData are not directly saved in db
        em.detach(updatedCommonFieldData);
