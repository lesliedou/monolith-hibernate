...
import com.begcode.demo.hibernate.security.AuthoritiesConstants;
...
import com.begcode.demo.hibernate.service.dto.PasswordChangeDTO;
import com.begcode.demo.hibernate.service.mapper.UserMapper;
import com.begcode.demo.hibernate.web.rest.vm.KeyAndPasswordVM;
import com.begcode.demo.hibernate.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        Set<AuthorityDTO> authorities = new LinkedHashSet<>();
    ...
    void testRegisterValid() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).ifPresent(validUser::setAuthorities);
    ...
    void testRegisterInvalidLogin() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).ifPresent(invalidUser::setAuthorities);
    ...
    void testRegisterDuplicateLogin() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.USER).map(Collections::singleton).ifPresent(firstUser::setAuthorities);
        ...
        secondUser.setAuthorities(new LinkedHashSet<>(firstUser.getAuthorities()));
    ...
    void testRegisterDuplicateEmail() throws Exception {
        ...
        userWithUpperCaseEmail.setAuthorities(new LinkedHashSet<>(firstUser.getAuthorities()));
    ...
    void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singleton).ifPresent(validUser::setAuthorities);
    ...
    void testSaveAccount() throws Exception {
        ...
        authorityService.findFirstByCode(AuthoritiesConstants.ADMIN).map(Collections::singleton).ifPresent(userDTO::setAuthorities);
