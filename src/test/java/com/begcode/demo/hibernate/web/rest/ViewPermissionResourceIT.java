...
public class ViewPermissionResourceIT {
    ...
    void getAllViewPermissionsWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        verify(viewPermissionRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void getAllViewPermissionsByChildrenIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, ViewPermission.class).isEmpty()) {
            viewPermissionRepository.saveAndFlush(viewPermission);
            children = ViewPermissionResourceIT.createEntity(em);
        } else {
            // children = TestUtil.findAll(em, ViewPermission.class).get(0);
    ...
    void getAllViewPermissionsByParentIsEqualToSomething() throws Exception {
        ...
        if (TestUtil.findAll(em, ViewPermission.class).isEmpty()) {
            viewPermissionRepository.saveAndFlush(viewPermission);
            parent = ViewPermissionResourceIT.createEntity(em);
        } else {
            // parent = TestUtil.findAll(em, ViewPermission.class).get(0);
